...
import 'package:frontend/services/fetch_parking_fee.dart';
import '../fee_management_component/parking_fee_card.dart';
...
class _AllState extends State<All> {
  late Future<ParkingFeeResponse?> futureFees;
  ...
  void initState() {
    super.initState();
    futureFees = fetchParkingFees().then((response) {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ParkingFeeResponse?>(
      future: futureFees,
