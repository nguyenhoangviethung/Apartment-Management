from sqlalchemy import ForeignKey, Column, Enum, INTEGER, JSON, String, Date, DECIMAL, FLOAT, NVARCHAR, DateTime, Index
...
class Households(db.Model):
    ...
    # Index cho primary key
    __table_args__ = (Index('idx_household_id', 'household_id'),)
...
class Residents(db.Model):
    ...
    # Index cho primary key
    __table_args__ = (Index('idx_resident_id', 'resident_id'),)
...
class Fees(db.Model):
    ...
    # Index cho primary key
    __table_args__ = (Index('idx_fee_id', 'fee_id'),)
...
class Contributions(db.Model):
    ...
    # Index cho primary key
    __table_args__ = (Index('idx_contribution_id', 'contribution_id'),)
...
class TokenBlacklist(db.Model):
    ...
    # Index cho primary key
    __table_args__ = (Index('idx_token_id', 'id'),)
...
class ParkingFees(db.Model):
    ...
    # Index cho primary key
    __table_args__ = (Index('idx_park_id', 'park_id'),)
...
class Vehicles(db.Model):
    ...
    # Index cho primary key
    __table_args__ = (Index('idx_vehicles_id', 'vehicles_id'),)
...
class Transactions(db.Model):
    ...
    # Index cho primary key
    __table_args__ = (Index('idx_transaction_id', 'transaction_id'),)
...
class Electrics(db.Model):
    ...
    # Index cho primary key
    __table_args__ = (Index('idx_customer_id_electric', 'customer_id'),)
...
class Waters(db.Model):
    ...
    # Index cho primary key
    __table_args__ = (Index('idx_customer_id_water', 'customer_id'),)